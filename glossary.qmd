...
**See Also:** {{< glink "best-fit line" >}}, {{< glink correlation >}}
...
An **area model** is a visual way to organize multiplication by breaking each number or expression into parts. Each part forms a row or column in a box, and the box cells show the partial products. When all the partial products are added together, you get the total product. Area models work for whole numbers, decimals, and polynomials of any size.
...
An operation is **associative** if **changing how the numbers are grouped** (parentheses) **doesn’t change the result**—as long as the operation is the same throughout.
...
* $(2 + 5) + 3 = 2 + (5 + 3) = 10$
* $(x + 4) + 6 = x + (4 + 6) = x + 10$
* $(2\cdot 3)\cdot x = 2\cdot(3\cdot x)$

**Common gotcha:**
Subtraction/division aren’t associative. Also, mixing operations breaks it: $a + (b\cdot c)$ is **not** the same as $(a + b)\cdot c$.

**Why it matters:**
Lets you **regroup** like terms to add coefficients more easily, e.g.,
...
An operation is **commutative** if **changing the order** of the numbers **doesn’t change the result**.
...
* Subtraction: $a - b \ne b - a$ (e.g., $7-3 \ne 3-7$)
* Division: $a \div b \ne b \div a$ (e.g., $8\div2 \ne 2\div8$)
* Exponents (in general): $a^b \ne b^a$
...
**Why it matters:**
Lets you **reorder** terms when simplifying, e.g., $2x + 5x + 3 = (2x + 5x) + 3$.
...
**See Also:** {{< glink factor >}}, {{< glink "prime factorization" >}}, {{< glink "prime factorization" >}}, {{< glink multiple >}}
...
The **domain** of a relationship or function is the set of all **input values** that are allowed or make sense in the situation.

> **Example:**  
> If $x$ represents the number of tickets sold, then the domain is whole numbers $0, 1, 2, \dots$ (you can’t sell a negative number of tickets).

**See Also:** {{< glink range >}}, {{< glink function >}}, {{< glink input >}}
...
A **function** is a rule that takes an **input**, does something to it, and produces exactly one **output**. We often write a function with a name like $f(x)$, which reads "f of x" and means “the rule $f$ applied to input $x$.”  

> **Example:**  
> If $f(x) = 2x+3$, then:  
> - Input 5 &rarr; Output 13  
> - Input -1 &rarr; Output 1

**See Also:** {{< glink "function notation" >}}, {{< glink output >}}, {{< glink input >}}, {{< glink  "linear equation" >}}
...
**See Also:** {{< glink factor >}}, {{< glink "prime factorization" >}}, {{< glink factoring >}}, {{< glink simplify >}}, {{< glink "relatively prime" >}}
...
Multiplication by **proximity** means to multiply two things that are next to each other but with no symbol like $\times$, $\cdot$, or $*$. You multiply them implicitly when they are next to each other.
...
**See Also:** {{< glink factor >}}, {{< glink "prime factorization" >}}, {{< glink "prime number" >}}, {{< glink product >}}, {{< glink "factor tree" >}}
