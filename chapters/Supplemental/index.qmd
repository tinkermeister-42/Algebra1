...
### [Printable Guided Notes](guided_notes.qmd)

  Fill-in notes for every lesson, ready to print.

### [Extra Practice Worksheets](worksheets/index.qmd)

  Targeted drills and alternative problem sets.

### [Challenge Problem Solutions](challenge_solutions.qmd)

  Solutions to all of the challenge problems.
