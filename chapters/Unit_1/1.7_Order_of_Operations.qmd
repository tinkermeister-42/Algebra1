...
:::{.callout-note icon=false title="📌 The Order of Operations"}
...
:::{.callout-note icon=false appearance="simple" collapse=true title="🧠 Why are multiplication and division grouped together?"}
...
:::{.callout-note appearance="simple" icon=false collapse=true title="🧠 Why is a negative times a negative positive?"}
...
::: {.callout-note icon=false appearance="simple" collapse=true title="🧠 Now you try: $-3 \times (4 - 7)$"}
...
:::{.callout-note appearance="simple" icon=false collapse=true title="🧠 Why are parentheses so important here?"}
...
::: {.callout-tip  title="What counts as grouping?"}
...
::: {.callout-note icon=false appearance="simple" collapse=true title="🧠 Now You Try: $\left[ 5 + (3^2 - 1) \right] \times 2$"}
