...
:::{.gotcha title="How many numbers are between any two numbers on the numberline?"}

**Example:** How many numbers between 3 and 5?

Though there are 2 {{< glink integers >}} between 3 and 5, the answer is not 2! There are {{< glink infinitely >}} many numbers between 3 and 5. Here are some number lines that might help convince you.
...
It is easy to get confused here. When we say which number is "bigger" (or greater than), we are asking which number is further to the right on the number line. This is **not** the same as absolute value, which asks which one is furthest from zero.
:::
...
:::{.think title="What real-world scenario could $200 - (-5) = 206$ represent?"}
