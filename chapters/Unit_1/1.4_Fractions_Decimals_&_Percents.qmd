...
- [ ] I can convert between fractions, decimals, and percents using place value, division, or benchmarks.
...
8. B. $\frac{3}{4} = 0.75$. 0.72 is only 0.03 units away from 0.75. The rest are further away.
