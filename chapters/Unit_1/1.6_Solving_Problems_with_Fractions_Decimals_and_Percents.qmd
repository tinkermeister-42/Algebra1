...
:::{.you-try title="If 3 out of 100 students get enough sleep, what percent is that?"}
$$
\frac{3}{100} = 0.03 = 3\%
$$
...
$20\% = \frac{1}{4}$ → So if one-fifth is 12, then the whole must be:
$$
12 \times 5 = 60
$$
Or use division:  
...
:::{.you-try title="A survey asked voters if the support Proposition A. 550 (or 55%) said they do support it. How many voters were surveyed?"}
