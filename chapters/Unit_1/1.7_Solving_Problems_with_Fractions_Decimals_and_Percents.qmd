# 1.7 - Solving Problems With Fractions, Decimals & Percents {.unnumbered}
...
:::{.guided-notes-link}
[Printable Guided Notes for this lesson](/guided_notes/Unit_1/1.7_Solving_Problems_with_Fractions_Decimals_and_Percents.html){target="_blank"} - fill-in notes to print and write on.
:::
...
### 1.7.1 - What’s the Part, Whole, or Percent?
...
You can also rearrange it to solve for the percent or the whole. We will go through all three types of problems step by step.
...
:::{.you-try title="A survey found that 550 students like cucumbers. That is 55% of the students surveyed. How many students were surveyed?"}
