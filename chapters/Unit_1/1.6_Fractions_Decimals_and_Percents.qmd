# 1.6 - Fractions, Decimals & Percents: Conversions {.unnumbered}
...
{{< glink equivalent >}},
{{< glink "place value" >}},
{{< glink "repeating decimal" >}}
:::

::: {.guided-notes-link}
[Printable Guided Notes for this lesson](/guided_notes/Unit_1/1.6_Fractions_Decimals_and_Percents.html){target="_blank"} &mdash; fill-in notes to print and write on.
:::
