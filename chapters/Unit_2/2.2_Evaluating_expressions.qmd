...
Once we know how to write algebraic expressions, the next step is to {{< glink evaluate >}} them. That means plugging in a number for each variable and simplifying the {{< glink result >}}. This is like testing what an expression equals when we know the value of the variable.

In this lesson, you’ll practice **substituting** values into expressions and using the {{< glink order of operations >}} (PEMDAS) to simplify. You’ll also start seeing how some expressions are always equal — even if they look different at first.
...
:::{.gotcha}
**Always** put parentheses around the number you substitute — especially if it’s negative!
:::
...
$$
20(5 - 2) + 2(5)^2 = 20(3) + 2(25) = 60 - 50 = 10
$$
