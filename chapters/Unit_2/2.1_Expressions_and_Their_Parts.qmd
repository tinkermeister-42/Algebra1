...
Learning mathematics is about more than number crunching, you’re learning a new language. Like any language, mathematics uses words and phrases to communicate ideas. In algebra, we call those words and phrases **expressions**.

In this lesson, you’ll learn to **read** expressions to understand the ideas they communicate and to **write** expressions to communicate your own ideas. To take the next step in the language of algebra, we’ll start with the basic building blocks of expressions: {{< glink slug="variable" text="variables" >}}, {{< glink slug="term" text="terms" >}}, {{< glink slug="coefficient" text="coefficients" >}}, and {{< glink slug="constant" text="constants" >}}.
...
:::{.guided-notes-link}
[Printable Guided Notes for this lesson](/guided_notes/Unit_2/2.1_Expressions_and_Their_Parts.html){target="_blank"} &mdash; fill-in notes to print and write on.
:::
...
An **expression** is a math phrase made of numbers, variables, and {{< glink slug="operation" text="operations" >}}. Expressions do **not** compare values, so $2x$ and $5$ are expressions, but $2x = 5$ is not (that’s an equation).
...
**Example 2:** Multiple boxes of apples
