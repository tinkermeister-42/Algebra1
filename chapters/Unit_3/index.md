...
Welcome to **Unit 3!** Here we move from working *with expressions* to solving **equations** and **inequalities**.
...
* **Solve one-step and two-step equations** by using inverse operations and check your work by substitution.
* **Simplify and solve multi-step equations**, including those with parentheses or like terms.
* **Handle equations with variables on both sides** and decide whether they have **one**, **none**, or **infinitely many** solutions.
