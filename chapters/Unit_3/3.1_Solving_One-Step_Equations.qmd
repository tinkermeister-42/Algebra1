...
To {{< glink solve >}} the equation, we only needed one step -- subtract 2 from each side. We always **undo addition by subtracting**. Subtraction is what we call the {{< glink inverse operation >}} for addition.
